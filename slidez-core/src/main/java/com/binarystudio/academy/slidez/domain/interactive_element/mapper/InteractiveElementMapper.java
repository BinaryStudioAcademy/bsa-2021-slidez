...
public interface InteractiveElementMapper {
	 ...
	 */
	default InteractiveElementDto interactiveElementToTypeRelatedDto(InteractiveElement element) throws IllegalElementTypeException {
		...
		throw new IllegalElementTypeException(String.format("Invalid type of element: %s", element.getClass().getName()));
	}
