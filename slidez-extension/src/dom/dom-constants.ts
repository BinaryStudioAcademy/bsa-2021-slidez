...
export const CLASS_NAME_PUNCH_VIEWER_PAGE_WRAPPER = 'punch-viewer-page-wrapper';
export const CLASS_NAME_PUNCH_VIEWER_SVGPAGE = 'punch-viewer-svgpage';
export const CLASS_NAME_PUNCH_VIEWER_SVGPAGE_SVGCONTAINER = 'punch-viewer-svgpage-svgcontainer';
